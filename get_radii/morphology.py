...
def add_pre(h,sec_list,section,order_list=None,branch_order=None,radius_list=None):
    """
    ...
    radius_list.append(section().diam/2)
    ...
    for next_node in sref.child:
        add_pre(h,sec_list,next_node,order_list,branch_order,radius_list)
...
def all_branch_orders(h):
    ...
    radius_list = []
    for r in roots:
        add_pre(h,[],r,order_list,0,radius_list)
    return order_list,radius_list
